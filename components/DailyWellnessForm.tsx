...
export function DailyWellnessForm() {
  ...
  const setters = { sleep: setSleep, fatigue: setFatigue, soreness: setSoreness, stress: setStress, mood: setMood };
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setIsSuccess(false);
    setLoading(true);
    const result = await submitDailyWellness(values);
    setLoading(false);
    if (result.error) {
