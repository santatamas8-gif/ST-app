...
export function LoginForm({ teamLogoUrl }: { teamLogoUrl: string | null }) {
  ...
  return (
    <div className="login-page-bg relative flex min-h-screen flex-col items-center justify-start overflow-hidden px-4 pt-4 pb-10 min-[480px]:pt-5 min-[480px]:pb-14">
      <header className="relative z-10 mb-12 mt-0 text-center sm:mb-16">
        <h1 className="text-xl font-bold tracking-tight text-white sm:text-2xl">
          ST<span className="mx-1 inline-block h-0.5 w-2.5 align-middle bg-zinc-600/60" aria-hidden /><span className="text-[#1eb871]">AMS</span>
        </h1>
        <p className="mt-0.5 text-sm font-normal text-zinc-400 sm:text-base">
          Athlete Monitoring System
        </p>
      </header>

      <div className="relative z-10 mt-4 w-full max-w-sm sm:mt-6">
        <div
