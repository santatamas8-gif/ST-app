            ...
            <div>
              ...
              <div className="relative mt-1.5">
                <input
                  ...
                  minLength={6}
                  className="block w-full rounded-lg border border-zinc-700 bg-zinc-800/50 py-2 pl-3 pr-10 text-white placeholder-zinc-500 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500"
                  placeholder="••••••••"
                />
                <button
                  type="button"
